...
public static class ItemDatabase
{
	...
	public static Item GRASS_PATCH = new PlantableResource (4, "Grass Patch", "It's a patch of grass.", 2.0f, TileDatabase.SOIL, TileDatabase.DIRT);
	public static Item WATER_BUCKET = new PlantableResource (5, "Bucket of Water", "Don't drown!", 2.0f, TileDatabase.SHALLOW_WATER, TileDatabase.HOLE);
