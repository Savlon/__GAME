...
public static class ItemDatabase
{
	...
	public static Item ROCK_WALL = new PlantableResource (7, "Rock Wall", "Keeps every cunt out...", 2.0f, TileDatabase.ROCK, null);
	...
	public static Item PICKAXE = new Instrument (6, "Pickaxe", "Rock cracker...", 1.3f, InstrumentType.PICKAXE, 6, 4, TileDatabase.AIR, TileDatabase.ROCK);
